...
public final class DataExport {
    ...
    private static JsonObject activity(PlayerStats s) {
        ...
        int[] heartbeat = s.getHourHeartbeat();
        ...
        o.add("heartbeatsByHour", h);
        o.addProperty("heartbeats", s.getHeartbeats());
        o.addProperty("lastHeartbeatAt", s.getLastHeartbeatAt() > 0L ? Text.dateTime(s.getLastHeartbeatAt()) : "");
        o.addProperty("lastHeartbeat", s.getLastHeartbeatInfo());
        o.add("heldItems", map(s.getHeldItems()));
        o.add("heartbeatWorlds", map(s.getHeartbeatWorld()));
        return o;
    }
